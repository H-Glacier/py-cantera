...
gas = ct.Solution(reaction_mechanism) #instanciate the solution object in order to use the mechanism file data
...
f = ct.CounterflowDiffusionFlame(gas, initial_grid)#create the counter flow diffusion flame problem
